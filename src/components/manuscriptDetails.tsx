                ...
                <div className="hc2columns">
                    <div className="hcBasicSideMargin">
                        ...
                        <div className="hcMarginBottom1">
                            ...
                            {typeHelp && (<div className="hcFacetHelp" onClick={() => {setTypeHelp(false)}}>
                                refers to the character of manuscripts transmitting the <em>Etymologiae</em>. Manuscripts transmitting only the <em>Etymologiae</em> are designated as <strong>Big Isidores</strong>. Other manuscripts are assigned to a category based on a notable thematic profile. Not all texts found in these manuscripts must fit this profile, but the majority does. Manuscripts that do not fit into any of the profiles are classified as <strong>miscellanies</strong>. In case the thematic design of a manuscript cannot be established due to its fragmentary preservation, it is labelled as <strong>unknown</strong>.
                            </div>)}
                            {props.manuscript.type}
                        </div>
                        <div className="hcMarginBottom1">
                            <div className="hcDataLabel">Transmission format <div className="detailHelp"
                                                                                  onClick={() => setHelp(!help)}><img
                                className="hcIconHelpDetail"
                                src="https://d33wubrfki0l68.cloudfront.net/85886ca3e2d8c36ba06d7773a094512272453181/545f8/images/icons/icon-huc-help.svg"
                                alt=""/></div>
                            </div>
                            {help && (<div className="hcFacetHelp" onClick={() => {setHelp(false)}}>
                                Based on the way in which they transmit the material from Isidore’s work, manuscripts in the database are divided into three transmission formats:
                                <ul>
                                    <li><strong>canonical <em>Etymologiae</em></strong> transmit this material principally as it was structured and organized by Braulio of Zaragoza, that is as an encyclopaedic text;</li>
                                    <li><strong>non-canonical <em>Etymologiae</em></strong> transmit a part of Isidore’s text repurposed for a novel use by medieval users, not as an encyclopaedia;</li>
                                    <li>the label excerpts indicates a manuscript that transmits short excerpts from the <em>Etymologiae</em>.</li>
                                </ul>
                                The label <strong>unknown</strong> is used for manuscripts which cannot be placed into either of the three categories.
                ...
                <div className="hc2columns hcMarginTop2">
                    ...
                    <div className="hcBasicSideMargin">
                        <h2>Content <div className="detailHelp"
                            ...
                            src="https://d33wubrfki0l68.cloudfront.net/85886ca3e2d8c36ba06d7773a094512272453181/545f8/images/icons/icon-huc-help.svg"
                            alt=""/></div></h2>
                        {contentHelp && (<div className="hcFacetHelp" onClick={() => {setContentHelp(false)}}>
                            details the sections of the <em>Etymologiae</em> appearing in the manuscript. Each unit of transmission is described separately.
                        </div>)}
                        {content.map(item => {
                    ...
                    <div className="hcBasicSideMargin">
                        <h2>Additional content <div className="detailHelp"
                            ...
                            alt=""/></div></h2>
                        <div className="hcMarginBottom1">
                            {addHelp && (<div className="hcFacetHelp" onClick={() => {setAddHelp(false)}}>
                                Lists texts appearing in the manuscript side by side with the material from the <em>Etymologiae</em>.
                            </div>)}
                            <ul>
                    ...
                    <div className="hcBasicSideMargin hcMarginTop3">
                        <div className="hcMarginBottom1">
                            <div className="hcDataLabel">Larger unit <div className="detailHelp"
                                                                         onClick={() => setLargeHelp(!largeHelp)}><img
                                className="hcIconHelpDetail"
                                src="https://d33wubrfki0l68.cloudfront.net/85886ca3e2d8c36ba06d7773a094512272453181/545f8/images/icons/icon-huc-help.svg"
                                alt=""/></div>
                            </div>
                            {largeHelp && (<div className="hcFacetHelp" onClick={() => {setLargeHelp(false)}}>
                                If material from the <em>Etymologiae</em> appears in the manuscript embedded into a larger collection, this collection is named or briefly described here.
                            </div>)}
                        ...
                        <div className="hcMarginBottom1">
                            <div className="hcDataLabel">Related manuscripts <div className="detailHelp"
                                                                                  onClick={() => setRelHelp(!relHelp)}><img
                                className="hcIconHelpDetail"
                                src="https://d33wubrfki0l68.cloudfront.net/85886ca3e2d8c36ba06d7773a094512272453181/545f8/images/icons/icon-huc-help.svg"
                                alt=""/></div>
                            </div>
                            {relHelp && (<div className="hcFacetHelp" onClick={() => {setRelHelp(false)}}>
                                if the manuscript shares an innovation with other manuscripts in our outside of the database, the nature of the innovation is shortly described and the manuscripts are listed here. Manuscripts with a record view in the database are linked.
                            </div>)}
